...
public class AdminUsuarios_Programa extends javax.swing.JFrame {

    CPrograma cp = new CPrograma();
    SQLPrograma sqlp = new SQLPrograma();
    private String dato;

    public AdminUsuarios_Programa() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Programa Academico");
        ...
        jPanel2.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 113, -1, -1));

        txtcodigo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtcodigo.setBorder(null);
        jPanel2.add(txtcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 237, 37));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 148, 37));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 150, 148, 37));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(109, 320, 730, 184));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 148, 37));
        ...
        jPanel2.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 237, 37));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 210, 240, 90));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        sqlp.Registrar(txtcodigo, txtNombre, jTextAreaDescripcion, cp);
        sqlp.mostrar(jTable1);
    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        sqlp.eliminar(txtcodigo, txtNombre, jTextAreaDescripcion);
        sqlp.mostrar(jTable1);
    }//GEN-LAST:event_jButton3MouseClicked

    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        sqlp.cargarDatos(jTable1, txtcodigo, txtNombre, jTextAreaDescripcion);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AdminUsuarios_Programa().setVisible(true);
        });
    }
