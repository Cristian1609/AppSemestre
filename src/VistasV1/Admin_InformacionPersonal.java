...
public class Admin_InformacionPersonal extends javax.swing.JFrame {

    private String dato;
    CLlenarCombo Lc = new CLlenarCombo();
    SQLAdministrador sqla = new SQLAdministrador();
    CAdministrador admin = new CAdministrador();

    public Admin_InformacionPersonal() {
        initComponents();
    ...
    public void setDato(String dato) {
        ...
        sqla.mostrarDatos(admin, dato, lblDato, lblNombre, lblTidentificacion, lblNidentificacion1, lblCorreo, lblTelefono, lblFnacimiento, lblSexo, lblEps, lblCodigoInstitucional, lblCoreoInstitucional, lblContraseña, txtNombre, comboIdentificacion, txtNumeroIdentificacion, txtCorreoPersonal, txtTelefono, comboSexo, ComboEps);
    ...
    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        try {
            sqla.ModificarDatos(txtNombre, comboIdentificacion, txtNumeroIdentificacion, txtCorreoPersonal, txtTelefono, comboSexo, ComboEps, dato);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Admin_InformacionPersonal().setVisible(true);
        });
    }
