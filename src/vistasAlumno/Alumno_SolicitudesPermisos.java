...
public class Alumno_SolicitudesPermisos extends javax.swing.JFrame {

    AdminUsuarios adminU = new AdminUsuarios();
    private String dato;

    public Alumno_SolicitudesPermisos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Solicitud Informes");
        ...
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(2, 2, 756, 68));
        jPanel2.add(txtdias, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 90, 30));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 330, 90));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, 194, 32));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        director.Director(permisoBuilder);

        permisoBuilder.setCodigoAlumno(lblDato.getText());
        permisoBuilder.setDetalle(jTextArea1.getText());
        
        String dias = txtdias.getText();
        permisoBuilder.setDias(Integer.parseInt(dias));
        
        SolicitudPersmiso solicitud = (SolicitudPersmiso) director.LLenarSolicitud();
        
        SQLSolicitudes sql = new SQLSolicitudes();
        
        sql.RegistrarSolicitud(solicitud);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Alumno_SolicitudesPermisos().setVisible(true);
        });
    }
