...
public class Alumno_InformacionPersonal extends javax.swing.JFrame {
    ...
    public void setDato(String dato) {
        ...
        sql.mostrarDatos(dato, lblDato, lblNombre, lblTidentificacion, lblNidentificacion1, lblCorreo, lblTelefono, lblFnacimiento, lblSexo, lblEps, lblCodigoInstitucional, lblCoreoInstitucional, lblContraseña, txtNombre, comboIdentificacion, txtNumeroIdentificacion, txtCorreoPersonal, txtTelefono, comboSexo, ComboEps);
    ...
    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        try {
            sql.ModificarDatos(txtNombre, comboIdentificacion, txtNumeroIdentificacion, txtCorreoPersonal, txtTelefono, comboSexo, ComboEps, dato);
