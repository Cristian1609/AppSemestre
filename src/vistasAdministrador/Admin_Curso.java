...
public class Admin_Curso extends javax.swing.JFrame {
    ...
    public Admin_Curso() {
        initComponents();
        Lc.LlenarCombo("Asignatura", "nombre", comboAsignatura);
        sql.Mostrar(jTable1);
    ...
    private void initComponents() {
        ...
        jLabel23.setText("Asignatura:");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, -1, -1));

        jPanel2.add(comboAsignatura, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, 240, 30));

        txtNombre.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNombre.setBorder(null);
        jPanel2.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 237, 37));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        SQLCurso sqc = new SQLCurso();
        CCurso cc = new CCurso();
        sqc.registrarCurso(cc, txtcodigo, txtNombre, comboAsignatura);
        sql.Mostrar(jTable1);
