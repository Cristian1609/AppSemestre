...
public class Admin_MenuCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Registro Cursos");
        jButton3.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 0, 255), new java.awt.Color(0, 0, 204)));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, 148, 37));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, 148, 37));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        AdminCursos_Horarios adminC = new AdminCursos_Horarios();
        adminC.setDato(dato);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Admin_MenuCurso().setVisible(true);
        });
    }
