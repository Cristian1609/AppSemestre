...
import Clases.CEps;
import Clases.CSemestre;
import Factory.IUsuario;
import Clases.SQLEps;
import Clases.SQLSemestre;
...
public class AdminUsuarios_Semestre extends javax.swing.JFrame {

    SQLSemestre sqlS = new SQLSemestre();
    CSemestre cs = new CSemestre();
    private String dato;

    public AdminUsuarios_Semestre() {
        initComponents();
        sqlS.Mostrar(jTable1);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        sqlS.Registrar(txtAño, cs);
        sqlS.Mostrar(jTable1);
    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        sqlS.Eliminar(txtAño);
        sqlS.Mostrar(jTable1);
    }//GEN-LAST:event_jButton3MouseClicked

    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        sqlS.Cargar(jTable1, txtAño);
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        try {
            ...
            if (filaSeleccionada >= 0) {
                int semestreID = Integer.parseInt(jTable1.getValueAt(filaSeleccionada, 0).toString());

                boolean resultado = SQLSemestre.modificarEps(semestreID, txtAño);

                if (resultado) {
                    JOptionPane.showMessageDialog(null, "semestre modificada con éxito.");
                } else {
                    JOptionPane.showMessageDialog(null, "No se pudo modificar el semestre.");
                }
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AdminUsuarios_Semestre().setVisible(true);
        });
    }
