...
public class Admin_Asignatura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 230, 148, 37));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 230, 148, 37));
        ...
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 140, 80, -1));
        ...
        jPanel2.add(Pensum, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 100, 237, -1));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 230, 148, 37));

        jPanel2.add(Semestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 140, 237, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        sa.Registrar(cas, txtCodigo, txtNombre, txtNcreditos, Semestre, Pensum);
        this.sa.mostrar(tablaAsignaturas);

    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        sa.modificar(cas, txtCodigo, txtNombre, txtNcreditos, Semestre, Pensum);
        sa.mostrar(tablaAsignaturas);
    ...
    private void tablaAsignaturasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaAsignaturasMouseClicked
        ...
        sa.cargarDatosDesdeTabla(tablaAsignaturas, txtCodigo, txtNombre, txtNcreditos, Semestre, Pensum);
