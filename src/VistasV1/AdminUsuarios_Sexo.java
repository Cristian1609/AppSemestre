...
public class AdminUsuarios_Sexo extends javax.swing.JFrame {

    SQLSexo ss = new SQLSexo();
    CSexo s = new CSexo();
    private String dato;

    public AdminUsuarios_Sexo() {
        initComponents();
        ss.Mostrar(TablaSexo);
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Tipos de Sexo");
        ...
        TablaSexo.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        TablaSexo.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        TablaSexo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        TablaSexo.setGridColor(new java.awt.Color(255, 255, 255));
        TablaSexo.setOpaque(false);
        TablaSexo.setRowHeight(30);
        TablaSexo.setSelectionBackground(new java.awt.Color(0, 0, 0));
        TablaSexo.setSelectionForeground(new java.awt.Color(255, 255, 255));
        TablaSexo.setShowGrid(false);
        TablaSexo.getTableHeader().setReorderingAllowed(false);
        TablaSexo.setUpdateSelectionOnSort(false);
        TablaSexo.setVerifyInputWhenFocusTarget(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel20, javax.swing.GroupLayout.DEFAULT_SIZE, 816, Short.MAX_VALUE))
        );
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 820, 520));
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        try {
            int filaSeleccionada = TablaSexo.getSelectedRow();

            if (filaSeleccionada >= 0) {
                int idRol = Integer.parseInt(TablaSexo.getValueAt(filaSeleccionada, 0).toString());

                boolean resultado = SQLSexo.modificarSexo(idRol, txtSexo);

                if (resultado) {
                    JOptionPane.showMessageDialog(null, "Tipo de sexo modificado con éxito.");
                } else {
                    JOptionPane.showMessageDialog(null, "No se pudo modificar el Tipo de sexo modificado.");
                }
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AdminUsuarios_Sexo().setVisible(true);
        });
    }
