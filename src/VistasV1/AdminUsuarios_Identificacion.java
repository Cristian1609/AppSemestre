...
public class AdminUsuarios_Identificacion extends javax.swing.JFrame {

    CTipoIdentificacion identificacion = new CTipoIdentificacion();
    SQLTipoIdentificacion SQLTi = new SQLTipoIdentificacion();
    private String dato;

    public AdminUsuarios_Identificacion() {
        initComponents();
        SQLTi.Mostrar(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Tipos de Identificación");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtTipoIdentificacion, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel20, javax.swing.GroupLayout.DEFAULT_SIZE, 836, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtTipoIdentificacion, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel21)
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 840, 520));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        SQLTi.Registrar(txtTipoIdentificacion, identificacion);
        SQLTi.Mostrar(jTable1);
    }//GEN-LAST:event_jButton1MouseClicked

    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        SQLTi.Eliminar(txtTipoIdentificacion);
        SQLTi.Mostrar(jTable1);
    }//GEN-LAST:event_jButton2MouseClicked

    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        SQLTi.Cargar(jTable1, txtTipoIdentificacion);
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        try {
            ...
            if (filaSeleccionada >= 0) {
                int tipoIdentificacion = Integer.parseInt(jTable1.getValueAt(filaSeleccionada, 0).toString());

                boolean resultado = SQLTipoIdentificacion.modificarTipoIentificacion(tipoIdentificacion, txtTipoIdentificacion);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AdminUsuarios_Identificacion().setVisible(true);
        });
    }
